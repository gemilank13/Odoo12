...
class PRBalanceSheetWizard(models.TransientModel):
    ...
    unit_kerja = fields.Selection([ ('TOT', 'TOTAL'),('ALL', 'ALL'), ('BOB', 'BOB'),('ACW', 'ACW'), ('SOR', 'SOR'), ('CIG', 'CIG')],'Unit Kerja', default="TOT")
    ...
    def call_pr_balance_sheet(self):
        ...
        cr.execute("select pr_balance_sheet(%s,%s,%s,%s,%s)",(self.date_start, self.date_end, self.date_start2, self.date_end2, uk))
