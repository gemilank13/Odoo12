...
class PRBalanceSheetWizard(models.TransientModel):
    ...
    date_start = fields.Date(string='Date Start',default=datetime.today() )
    date_end = fields.Date(string='Date End', default=datetime.today()+timedelta(days=30))

    date_start2 = fields.Date(string='Date Start',default=datetime.today()-timedelta(days=365))
    date_end2 = fields.Date(string='Date End',default=datetime.today()-timedelta(days=335))
    ...
    currency_date = fields.Date(string="Currency Date", default=datetime.today())
