...
class BalanceSheetXlsx(models.AbstractModel):
    ...
    def generate_xlsx_report(self, workbook, data, lines):
        ...
        sheet2.write(4, 1, 'Current Month', format1)
        sheet2.write(4, 2, 'Year to Date', format1)
        ...
        for obj in lines:
            if obj.cur_period==0 and obj.prev_period==0:
                continue
            i = i + 1
            sheet2.write(i, 0, obj.name, format2)
            sheet2.write(i, 1, obj.cur_period * -1, money)
            sheet2.write(i, 2, obj.prev_period * -1, money)
            # sheet2.write(i, 4, obj.currency, format2)
            # sheet2.write(i, 5, obj.ori_cur_period, money)
            # sheet2.write(i, 6, obj.ori_prev_period, money)
        ...
        # sheet.write(i, 1, obj.name, format2)
        sheet2.write(i, 1, tot_cur_period_hpp * -1 , money)
        sheet2.write(i, 2, tot_prev_period_hpp * -1, money)

        i = i + 2
        sheet2.write(i, 0, "Cost of Production", format0)

        i = i + 1
        sheet2.write(i, 0, "Material Cost", format0)
        ...
        i = i + 1
        sheet2.write(i, 0, "Direct Labor Cost", format0)
        ...
        i = i + 1
        sheet2.write(i, 0, "Indirect Labor Cost", format0)
        ...
        i = i + 1
        sheet2.write(i, 0, "Transportation", format2)
        ...
        i = i + 1
        sheet2.write(i, 0, "Energy Production", format2)
        ...
        i = i + 1
        sheet2.write(i, 0, "Maintenance", format2)
        ...
        i = i + 1
        sheet2.write(i, 0, "Other Overhead", format0)
        ...
        # sheet.write(i, 1, obj.name, format2)
        sheet2.write(i, 1, tot_cur_period_cost * -1, money)
        sheet2.write(i, 2, tot_prev_period_cost * -1, money)

        i = i + 2
        sheet2.write(i, 0, 'Gross Margin', format0)
        # sheet.write(i, 1, obj.name, format2)
        sheet2.write(i, 1, (tot_cur_period_cost + tot_cur_period_hpp) * -1, money)
        sheet2.write(i, 2, (tot_prev_period_cost + tot_prev_period_hpp) * -1, money)
        ...
        i = i + 1
        sheet2.write(i, 0, "Admin Personel Expenses", format2)
        ...
        for obj in lines:
            ...
            i = i + 1
            sheet2.write(i, 0, obj.name, format2)
            sheet2.write(i, 1, obj.cur_period , money)
            sheet2.write(i, 2, obj.prev_period, money)
            # sheet2.write(i, 4, obj.currency, format2)
            # sheet2.write(i, 5, obj.ori_cur_period, money)
            # sheet2.write(i, 6, obj.ori_prev_period, money)
        ...
        i = i + 1
        sheet2.write(i, 0, "Facility Expenses", format2)
        ...
        i = i + 1
        sheet2.write(i, 0, "Vehicle Expenses", format2)
        ...
        i = i + 1
        sheet2.write(i, 0, "IT Expenses", format2)
        ...
        i = i + 1
        sheet2.write(i, 0, "General Admin Expenses", format2)
        ...
        # sheet.write(i, 1, obj.name, format2)
        sheet2.write(i, 1, tot_cur_period_exp, money)
        sheet2.write(i, 2, tot_prev_period_exp, money)

        i = i + 2
        sheet2.write(i, 0, 'EBITDA', format0)
        # sheet.write(i, 1, obj.name, format2)
        sheet2.write(i, 1, (tot_cur_period_exp + tot_cur_period_cost + tot_cur_period_hpp) * -1, money)
        sheet2.write(i, 2, (tot_prev_period_exp + tot_prev_period_cost + tot_prev_period_hpp) * -1, money)


        i = i + 2
        sheet2.write(i, 0, "Depreciation", format2)
        ...
        i = i + 1
        sheet2.write(i, 0, "Amortization", format2)
        ...
        # sheet.write(i, 1, obj.name, format2)
        sheet2.write(i, 1, tot_cur_period_dep * -1, money)
        sheet2.write(i, 2, tot_prev_period_dep * -1, money)

        i = i + 2
        sheet2.write(i, 0, 'EBIT', format0)
        # sheet.write(i, 1, obj.name, format2)
        sheet2.write(i, 1, (tot_cur_period_dep + tot_cur_period_exp + tot_cur_period_cost + tot_cur_period_hpp) * -1, money)
        sheet2.write(i, 2, (tot_prev_period_dep + tot_prev_period_exp + tot_prev_period_cost + tot_prev_period_hpp) * -1, money)
        ...
        i = i + 1
        sheet2.write(i, 0, "Other Income", format2)
        ...
        i = i + 1
        sheet2.write(i, 0, "Other Expenses", format2)
        lines = self.env['pr.balance_sheet'].search([('account_type', '=', 'Other Expenses')])
        for obj in lines:
            if obj.cur_period==0 and obj.prev_period==0:
                continue
            i = i + 1
        ...
        # sheet.write(i, 1, obj.name, format2)
        sheet2.write(i, 1, tot_cur_other_ie * -1, money)
        sheet2.write(i, 2, tot_prev_other_ie * -1, money)

        i = i + 2
        sheet2.write(i, 0, 'Net Income/(loss)', format0)
        # sheet.write(i, 1, obj.name, format2)
        sheet2.write(i, 1, (tot_cur_other_ie + tot_cur_period_dep + tot_cur_period_exp + tot_cur_period_cost + tot_cur_period_hpp) * -1, money)
        sheet2.write(i, 2, (tot_prev_other_ie + tot_prev_period_dep + tot_prev_period_exp + tot_prev_period_cost + tot_prev_period_hpp) * -1, money)


        i = i + 2
        sheet2.write(i, 0, "Taxes", format2)
        tot_cur_tex = 0
        tot_prev_tax = 0
        ...
        sheet.write(4,1,'Current Month',format1)
        sheet.write(4,2,'Year to Date',format1)
        tot_cur_period = 0
        tot_prev_period = 0
        ...
        i = i + 1
        sheet.write(i, 0, "Cash & Cash equivalents", format2)
        ...
        i = i + 1
        sheet.write(i, 0, "Receivable", format2)
        ...
        i = i + 1
        sheet.write(i, 0, "Other Receivable", format2)
        ...
        i = i + 1
        sheet.write(i, 0, "Prepayments", format2)
        ...
        i = i + 1
        sheet.write(i, 0, "Prepaid Tax", format2)
        ...
        i = i + 1
        sheet.write(i, 0, "Inventory Stock Material", format2)
        ...
        i = i + 1
        sheet.write(i, 0, "Inventory Semi Finished Goods", format2)
        ...
        i = i + 1
        sheet.write(i, 0, "Inventory Sparepart", format2)
        ...
        i = i + 1
        sheet.write(i, 0, "Other Current Assets", format2)
        ...
        i = i + 1
        sheet.write(i, 0, "Fixed Assets Acquisition", format2)
        ...
        i = i + 1
        sheet.write(i, 0, "Accumulation Depreciation", format2)
        ...
        i = i + 1
        sheet.write(i, 0, "Itangible Assets", format2)
        lines = self.env['pr.balance_sheet'].search([('account_type', '=', 'Itangible Assets')])
        for obj in lines:
            if obj.cur_period==0 and obj.prev_period==0:
                continue
            i = i + 1
        ...
        i = i + 1
        sheet.write(i, 0, "Other Non Current Assets", format2)
        ...
        sheet.write(i, 1, tot_non_cur_period, money)
        sheet.write(i, 2, tot_non_prev_period, money)

        i=i+2
        sheet.write(i, 0,'Total Assets', format0)
        sheet.write(i, 1, (tot_cur_period+tot_non_cur_period), money)
        sheet.write(i, 2, (tot_prev_period+tot_non_prev_period), money)
        ...
        i = i + 1
        sheet.write(i, 0, "Other Payable", format2)
        ...
        i = i + 1
        sheet.write(i, 0, "Tax Payable", format2)
        ...
        i = i + 1
        sheet.write(i, 0, "Accruals And Deferred Income", format2)
        ...
        i = i + 1
        sheet.write(i, 0, "S/T Loans", format2)
        ...
        i = i + 1
        sheet.write(i, 0, "S/T Provision", format2)
        ...
        # sheet.write(i, 1, obj.name, format2) 
        sheet.write(i, 1, tot_cur_period_hutang * -1, money)
        sheet.write(i, 2, tot_prev_period_hutang * -1, money)
        ...
        i = i + 1
        sheet.write(i, 0, "L/T Loans", format2)
        ...
        i = i + 1
        sheet.write(i, 0, "L/T Provision", format2)
        ...
        i = i + 1
        sheet.write(i, 0, "Other Non Current Liabilities", format2)
        ...
        # sheet.write(i, 1, obj.name, format2) 
        sheet.write(i, 1, (tot_non_cur_period_hutang * -1), money)
        sheet.write(i, 2, (tot_non_prev_period_hutang * -1), money)
        ...
        i = i + 1
        sheet.write(i, 0, "Share & Capital Reserves", format2)
        ...
        i = i + 1
        sheet.write(i, 0, "Dividend", format2)
        ...
        i = i + 1
        sheet.write(i, 0, "Profit/Loss Carried Forward", format2)
        ...
        i = i + 1
        sheet.write(i, 0, "Profit/Loss Of Period", format2)
        ...
        i = i + 1
        sheet.write(i, 0, "Other Equity Component", format2)
        ...
        # sheet.write(i, 1, obj.name, format2)
        sheet.write(i, 1, tot_cur_period_modal * -1, money)
        sheet.write(i, 2, tot_prev_period_modal * -1, money)
        ...
        sheet.write(i, 1, (tot_non_cur_period_hutang-tot_cur_period_hutang+tot_cur_period_modal) * -1, money)
        sheet.write(i, 2, (tot_non_prev_period_hutang-tot_prev_period_hutang+tot_prev_period_modal) * -1, money)
        ...
        # i = i + 1
        # sheet.write(i, 0, "Fixed Asset", format0)
        ...
        # i = i + 1
        # sheet.write(i, 0, "Receivable", format0)
        ...
        # i = i + 1
        # sheet.write(i, 0, "Current Liabilities", format0)
        # lines = self.env['pr.balance_sheet'].search([('account_type', '=', 'Current Liabilities')])
        # for obj in lines:
        #     if obj.cur_period==0 and obj.prev_period==0:
        #         continue
        ...
        # i = i + 2
        # sheet.write(i, 0, "Current Year Earning", format0)
        # tot_cur_period_modal =  0
        # tot_prev_period_modal =  0
        # lines = self.env['pr.balance_sheet'].search([('account_type', '=', 'Current Year Earnings')])
        # for obj in lines:
        ...
        # sheet.write(i, 0, 'Total Liabilities and Equity', format0)
        # # sheet.write(i, 1, obj.name, format2)
        # sheet.write(i, 1, (tot_cur_period_modal+tot_cur_period_hutang) * -1, money)
        # sheet.write(i, 2, (tot_prev_period_modal+tot_prev_period_hutang) * -1, money)
