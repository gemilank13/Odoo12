...
class BalanceSheetXlsx(models.AbstractModel):
    ...
    def generate_xlsx_report(self, workbook, data, lines):
        ...
        sheet2.write(4, 2, 'Current Month', format1)
        ...
        i = i + 1
        sheet2.write(i, 1, "Transportation", format2)
        ...
        i = i + 1
        sheet2.write(i, 1, "Energy Production", format2)
        ...
        i = i + 1
        sheet2.write(i, 1, "Maintenance", format2)
        ...
        i = i + 1
        sheet2.write(i, 1, "Admin Personel Expenses", format2)
        ...
        i = i + 1
        sheet2.write(i, 1, "Facility Expenses", format2)
        ...
        i = i + 1
        sheet2.write(i, 1, "Vehicle Expenses", format2)
        ...
        i = i + 1
        sheet2.write(i, 1, "IT Expenses", format2)
        ...
        i = i + 1
        sheet2.write(i, 1, "General Admin Expenses", format2)
        ...
        i = i + 1
        sheet2.write(i, 1, "Other Income", format2)
        ...
        i = i + 1
        sheet2.write(i, 1, "Other Expenses", format2)
        ...
        sheet.write(4,2,'Current Month',format1)
        ...
        i = i + 1
        sheet.write(i, 1, "Cash & Cash equivalents", format2)
        ...
        i = i + 1
        sheet.write(i, 1, "Receivable", format2)
        ...
        i = i + 1
        sheet.write(i, 1, "Other Receivable", format2)
        ...
        i = i + 1
        sheet.write(i, 1, "Prepayments", format2)
        ...
        i = i + 1
        sheet.write(i, 1, "Prepaid Tax", format2)
        ...
        i = i + 1
        sheet.write(i, 1, "Inventory Stock Material", format2)
        ...
        i = i + 1
        sheet.write(i, 1, "Inventory Semi Finished Goods", format2)
        ...
        i = i + 1
        sheet.write(i, 1, "Inventory Sparepart", format2)
        ...
        i = i + 1
        sheet.write(i, 1, "Other Current Assets", format2)
        ...
        i = i + 1
        sheet.write(i, 1, "Fixed Assets Acquisition", format2)
        ...
        i = i + 1
        sheet.write(i, 1, "Accumulation Depreciation", format2)
        ...
        i = i + 1
        sheet.write(i, 1, "Intangible Assets", format2)
        ...
        i = i + 1
        sheet.write(i, 1, "Other Non Current Assets", format2)
        ...
        i = i + 1
        sheet.write(i, 1, "Payable", format2)
        ...
        i = i + 1
        sheet.write(i, 1, "Other Payable", format2)
        ...
        i = i + 1
        sheet.write(i, 1, "Tax Payable", format2)
        ...
        i = i + 1
        sheet.write(i, 1, "Accruals And Deferred Income", format2)
        ...
        i = i + 1
        sheet.write(i, 1, "S/T Loans", format2)
        ...
        i = i + 1
        sheet.write(i, 1, "S/T Provision", format2)
        ...
        i = i + 1
        sheet.write(i, 1, "L/T Loans", format2)
        ...
        i = i + 1
        sheet.write(i, 1, "L/T Provision", format2)
        ...
        i = i + 1
        sheet.write(i, 1, "Other Non Current Liabilities", format2)
        ...
        i = i + 1
        sheet.write(i, 1, "Share & Capital Reserves", format2)
        ...
        i = i + 1
        sheet.write(i, 1, "Dividend", format2)
        ...
        i = i + 1
        sheet.write(i, 1, "Profit/Loss Carried Forward", format2)
        ...
        i = i + 1
        sheet.write(i, 1, "Profit/Loss Of Period", format2)
        ...
        i = i + 1
        sheet.write(i, 1, "Other Equity Component", format2)
        ...
        sheet.write(i, 2, (tot_non_cur_period_hutang-tot_cur_period_hutang+tot_cur_period_modal) * -1, money)
        sheet.write(i, 3, (tot_non_prev_period_hutang-tot_prev_period_hutang+tot_prev_period_modal) * -1, money)
