...
class PRBalanceSheet(models.Model):
    ...
    last_period=fields.Float(string='Last Period')
    ...
    def init(self):
        self.env.cr.execute("""
        DROP FUNCTION IF EXISTS pr_balance_sheet_v3(date, date, date,date);
        CREATE OR REPLACE FUNCTION pr_balance_sheet_v3(date_start date, date_end date, 
		date_start2 date, date_end2 date, date_start3 date, date_end3 date)
...
DECLARE
	...
	csr_piutang CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Receivable') order by x_code asc;
	...
	csr_aktiva_lancar CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Current Assets' or t5.name='Prepayments') order by x_code asc;
	...
	csr_otherreceivable CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Other Receivable') order by x_code asc;
	...
	csr_prepaidtax CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Prepaid Tax') order by x_code asc;
	...
	csr_inventorysm CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Inventory Stock Material') order by x_code asc;
	...
	csr_inventorysfg CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Inventory Semi Finished Goods') order by x_code asc;
	...
	csr_inventorys CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Inventory Sparepart') order by x_code asc;
	...
	csr_oca CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Other Current Assets') order by x_code asc;
	...
	csr_aktiva_tidak_lancar CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Non-current Assets') order by x_code asc;
	...
	csr_other_non_current_assets CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Other Non Current Assets') order by x_code asc;
	...
	csr_aktiva_tetap CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Fixed Assets Acquisition') order by x_code asc;
	...
	csr_acc_dep CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Accumulation Depreciation') order by x_code asc;
	...
	csr_land_assets CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Fixed Assets Land') order by x_code asc;
	...
	csr_assets_project CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Fixed Assets Project In Progress') order by x_code asc;
	...
	csr_hutang_lancar CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Payable' or t5.name = 'Current Liabilities') order by x_code asc;
	...
	csr_other_hutang_lancar CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Other Payable') order by x_code asc;
	...
	csr_tax_payable CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Tax Payable') order by x_code asc;
	...
	csr_provision CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'S/T Provision') order by x_code asc;
	...
	csr_hutang_jangka_panjang CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Non Current Liabilities') order by x_code asc;
	...
	csr_lt_provision CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'L/T Provision') order by x_code asc;
	...
	csr_other_non_current_liabilities CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Other Non Current Liabilities') order by x_code asc;
	...
	csr_modal CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Equity' or t5.name = 'Current Year Earnings') order by x_code asc;
	...
	csr_share CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Share & Capital Reserve') order by x_code asc;
	...
	csr_dividend CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Dividend') order by x_code asc;
	...
	csr_pl_carried CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Profit/Loss Carried Forward') order by x_code asc;
	...
	csr_pl_period CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Profit/Loss Of Period') order by x_code asc;
	...
	csr_other_equity CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Other Equity Component') order by x_code asc;
	...
	csr_pendapatan CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Income') order by x_code asc;
	...
	csr_hpp CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Cost of Revenue' or t5.name = 'Revenue') order by x_code asc;
	...
	csr_material_cost CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Material Cost') order by x_code asc;
	...
	csr_direct_cost CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Direct Labor Cost') order by x_code asc;
	...
	csr_indirect_cost CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Indirect Labor Cost') order by x_code asc;
	...
	csr_transportation CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Transportation') order by x_code asc;
	...
	csr_energy_production CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Energy Production') order by x_code asc;
	...
	csr_maintenance CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Maintenance') order by x_code asc;
	...
	csr_other_overhead CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Other Overhead') order by x_code asc;
	...
	csr_beban_adm CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Expenses' or t5.name = 'Depreciation') order by x_code asc;
	...
	csr_amortization CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Amortization') order by x_code asc;
	...
	csr_personel_expenses CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Admin Personel Expenses') order by x_code asc;
	...
	csr_vehicle_expenses CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Vehicle Expenses') order by x_code asc;
	...
	csr_general_admin_expenses CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'General Admin Expenses') order by x_code asc;
	...
	csr_pendapatan_lain CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Other Income' or t5.name = 'Interest Income') order by x_code asc;
	...
	csr_pce CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Profits on Currency Exchange') order by x_code asc;
	...
	csr_noi CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Non Operating Income') order by x_code asc;
	...
	csr_ei CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Extraordinary Income') order by x_code asc;
	...
	csr_beban_lain CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Other Expenses' or t5.name = 'Interest Expenses') order by x_code asc;
	...
	csr_lce CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Loss on Currency Exchange') order by x_code asc;
	...
	csr_noe CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Non Operating Expenses') order by x_code asc;
	...
	csr_ee CURSOR FOR 
		select t1.id as x_id, t1.code as x_code, t1.name x_name, 
			...
			left join res_currency t4 on t1.currency_id = t4.id
			join account_account_type t5 on t1.user_type_id = t5.id	
			where (t5.name = 'Extraordinary Expenses') order by x_code asc;
...
BEGIN
	...
	delete from pr_balance_sheet_v3;
	...
	for rec in csr_kas loop
		...
		from account_move_line t1
                join account_move t2 on t2.id=t1.move_id
		where t1.account_id = rec.x_id 
		and t1.date >= date_start3 and t1.date <= date_end3 and t2.state='posted'
		into x_last_period;
		if x_last_period is null then
			x_last_period=0;
		end if;
		raise notice 'x_last_period: %',x_last_period;

	    
	    insert into pr_balance_sheet_v3 (tgl_mulai, tgl_akhir, account_type, code, name, cur_period, prev_period, last_period, currency,
			...
			x_cur_period, x_prev_period, x_last_period, rec.currency,
