...
DECLARE
	...
	csr cursor for
		...
		((s.date_backdating is not null and (s.date_backdating >= '2021-01-01' and s.date_backdating <= ('2021-06-29'::DATE + 1))) or
						(s.date_backdating is null and (s.date >= '2021-01-01' and s.date <= ('2021-06-29'::DATE + 1))));
